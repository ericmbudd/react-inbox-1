export const clickMarkAsRead = (state = { allMessages: [] }, action) => {
    switch (action.type) {
...
export const markAsRead = (state = { allMessages: [] }, action) => {
...
export const markAsUnRead = (state = { allMessages: [] }, action) => {
